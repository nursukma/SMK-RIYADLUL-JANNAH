...
<form action="" method="post">
    <table>
    <tr><td colspan='2'>FORM PEMBAYARAN ATTRIBUT</td></tr>
    ...
    <tr><td>Sisa Pembayaran</td><td><input type="number" readonly name="sisa" id="sisa"></td></tr>
...
if(isset($_POST['submit'])){
    ...
    $query1 = mysqli_query($koneksi,'insert into tbl_bayar values("'.$id.'","'.$tanggal.'","ATRIBUT")') or die(mysqli_error($koneksi));
    if($query && $query1){
        ?> <script> 
        location.replace('bayar-atribut.php');
